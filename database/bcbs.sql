...
-- Create new database
CREATE
DATABASE badminton_court_booking;
GO
...
(
    ...
    [expire_at] [datetime] NOT NULL,
    [created_at] [datetime] NOT NULL CONSTRAINT [DF_PasswordResetToken_CreatedAt] DEFAULT
(
    GETDATE
(
))
...
CREATE UNIQUE INDEX UX_Facility_Thumbnail
    ON FacilityImage (facility_id) WHERE is_thumbnail = 1;
GO
...
(
    ...
    email_type      VARCHAR(20) NOT NULL
        CONSTRAINT CK_EmailQueue_EmailType CHECK (email_type IN (
                                                                 ...
                                                                 'REMINDER_UPCOMING_24H', 'REMINDER_UPCOMING_2H',
                                                                 'REMINDER_PAYMENT_12H',
...
CREATE
NONCLUSTERED INDEX IX_Court_FacilityId
ON Court(facility_id)
INCLUDE (court_id, court_name, court_type_id, is_active);

CREATE
NONCLUSTERED INDEX IX_Court_Facility_CourtType
...
CREATE
NONCLUSTERED INDEX IX_Booking_Account_Status
...
CREATE
NONCLUSTERED INDEX IX_BookingSlot_Court_Date_Slot
...
CREATE
NONCLUSTERED INDEX IX_BookingSlot_Date_Court_Status
...
CREATE
NONCLUSTERED INDEX IX_BookingSlot_BookingId
...
CREATE
NONCLUSTERED INDEX IX_FacilityPriceRule_Main
