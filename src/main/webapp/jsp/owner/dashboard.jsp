	...
	<div class="dov-wrap">
                ...
                <div class="dov-card dov-fadein dov-d1">
                    <div class="dov-stat-top">
                        ...
                        <span class="dov-stat-badge dov-stat-badge--up">
                            ...
                            ${not empty sessionScope.dailyRevenue.changePercent ? sessionScope.dailyRevenue.formattedPercent : '0%'}
                        </span>
                    </div>
                    <p class="dov-stat-label">Doanh thu hằng ngày</p>
                    <p class="dov-stat-value">
                        ${not empty sessionScope.dailyRevenue.currentAmount ? sessionScope.dailyRevenue.formattedAmount : '0 VND'}
                    </p>
                </div>
		<%-- ============================================================
             STAT CARDS
			...
			<div class="dov-card dov-fadein dov-d1">
                ...
                <div class="dov-card dov-fadein dov-d2">
                    <div class="dov-stat-top">
                        ...
                        <span class="dov-stat-badge dov-stat-badge--up">
                            <i class="bi bi-graph-up-arrow"></i>
                            ${not empty sessionScope.weeklyRevenue.changePercent ? sessionScope.weeklyRevenue.formattedPercent : '0%'}
                        </span>
                    </div>
                    <p class="dov-stat-label">Doanh thu hằng tuần</p>
                    <p class="dov-stat-value">
                        ${not empty sessionScope.weeklyRevenue.currentAmount ? sessionScope.weeklyRevenue.formattedAmount : '0 VND'}
                    </p>
                </div>
			<%-- Weekly Revenue --%>
			<div class="dov-card dov-fadein dov-d2">
                ...
                <div class="dov-card dov-fadein dov-d3">
                    <div class="dov-stat-top">
                        ...
                        <span class="dov-stat-badge dov-stat-badge--up">
                            <i class="bi bi-graph-up-arrow"></i>
                            ${not empty sessionScope.monthlyRevenue.changePercent ? sessionScope.monthlyRevenue.formattedPercent : '0%'}
                        </span>
                    </div>
                    <p class="dov-stat-label">Doanh thu hằng tháng</p>
                    <p class="dov-stat-value">
                        ${not empty sessionScope.monthlyRevenue.currentAmount ? sessionScope.monthlyRevenue.formattedAmount : '0 VND'}
                    </p>
                </div>
			<%-- Monthly Revenue --%>
			<div class="dov-card dov-fadein dov-d3">
                ...
                <div class="dov-card dov-fadein dov-d4">
                    <div class="dov-stat-top">
                        ...
                        <span class="dov-stat-badge dov-stat-badge--up">
                            <i class="bi bi-graph-up-arrow"></i>
                            ${not empty sessionScope.yearlyRevenue.changePercent ? sessionScope.yearlyRevenue.formattedPercent : '0%'}
                        </span>
                    </div>
                    <p class="dov-stat-label">Doanh thu hằng năm</p>
                    <p class="dov-stat-value">
                        ${not empty sessionScope.yearlyRevenue.currentAmount ? sessionScope.yearlyRevenue.formattedAmount : '0 VND'}
                    </p>
                </div>
            </div>
		...
		<div class="dov-two-col">
            ...
            <div class="dov-card dov-fadein dov-d10">
                <div class="dov-card-header">
                    <h3 class="dov-card-title">Phân tích giờ cao điểm trong 30 ngày gần nhất</h3>
                </div>
			<div class="dov-card dov-fadein dov-d8">
				<div class="dov-card-header">
					<h3 class="dov-card-title">Doanh thu trong năm</h3>
