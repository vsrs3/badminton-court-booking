...
<div class="dashboard-header">
    <div class="container">
        <div class="d-flex justify-content-between align-items-center">
            <div>
                <h1 class="mb-2" style="font-weight: 900;">Owner Dashboard</h1>
                <p class="mb-0">Xin chào, <%= owner.getFullName() %>!</p>
            </div>
    ...
    <div class="row g-4 mb-4">
        <div class="col-md-3">
            <div class="stat-card">
                ...
                <div class="stat-label">Cơ sở của tôi</div>
            </div>
        </div>
    ...
    <div class="row">
        <div class="col-12">
            <div class="dashboard-card">
                <h3 style="font-weight: 900; margin-bottom: 1.5rem;">Quản lý kinh doanh</h3>

                <div class="row g-3">
                    <div class="col-md-3">
                        <a href="#" class="btn btn-outline-success w-100 p-3">
                            <i class="bi bi-shop"></i><br>Quản lý cơ sở
                        </a>
                    </div>
                    <div class="col-md-3">
                        <a href="#" class="btn btn-outline-success w-100 p-3">
                            <i class="bi bi-people"></i><br>Quản lý nhân viên
                        </a>
                    </div>
                    <div class="col-md-3">
                        <a href="#" class="btn btn-outline-success w-100 p-3">
                            <i class="bi bi-calendar-event"></i><br>Xem đặt lịch
                        </a>
                    </div>
                    <div class="col-md-3">
                        <a href="#" class="btn btn-outline-success w-100 p-3">
                            <i class="bi bi-bar-chart"></i><br>Báo cáo doanh thu
                        </a>
                    </div>
                </div>
