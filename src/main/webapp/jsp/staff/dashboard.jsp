...
<div class="dashboard-container">
    <div class="dashboard-header">
        <div class="d-flex justify-content-between align-items-center">
            <div>
                ...
                <p class="text-muted mb-0">Chào mừng, <strong><%= currentUser.getFullName() %></strong> <span class="badge-role">STAFF</span></p>
            </div>
    ...
    <div class="alert alert-info">
        ...
        <strong>Thông báo:</strong> Giao diện Staff Dashboard đang được phát triển bởi team khác.
    </div>
        ...
        <div class="col-md-6">
            <div class="card">
                <div class="card-body text-center">
                    ...
                    <h3 class="mt-3">Quản lý đặt sân</h3>
        ...
        <div class="col-md-6">
            <div class="card">
                <div class="card-body text-center">
                    ...
                    <h3 class="mt-3">Quản lý hóa đơn</h3>
                    <p class="text-muted">Đang phát triển...</p>
                </div>
            </div>
        </div>
