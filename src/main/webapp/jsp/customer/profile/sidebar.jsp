...
<div class="flex flex-col h-full bg-white">
				...
				<div class="relative">
					<c:if test="${not empty sessionScope.account.avatarPath}">
						<img src="${pageContext.request.contextPath}/uploads/${sessionScope.account.avatarPath}"
							alt="Avatar" class="w-14 h-14 rounded-full border-2 border-white/30" />
	...
	<div class="p-4 bg-gray-50/50">
		<div class="grid grid-cols-4 gap-2">
            ...
            <a href="#" class="flex flex-col items-center justify-center p-2 rounded-xl bg-white border border-gray-100 shadow-sm hover:shadow-md transition-shadow cursor-pointer">
			...
			<a href="#" id="sidebarMapBtn" data-tab="map"
                ...
                <span class="text-[10px] text-gray-600 font-medium text-center">Bản Đồ</span>
			</a>
	...
	<div class="flex-1 pb-20">
		...
		<div class="flex items-center justify-between p-4 cursor-pointer border-b border-gray-50 transition-colors hover:bg-gray-50">
			<div class="flex items-center space-x-3">
				<i data-lucide="star" class="w-5 h-5 text-emerald-700"></i> 
                <span class="text-sm font-medium text-gray-700">Danh sách đánh giá</span>
			</div>
			<i data-lucide="chevron-right" class="w-4 h-4 text-gray-300"></i>
		</div>
