...
<div class="flex flex-col h-full bg-white">
	...
	<div class="flex-1">
		<a href="profile?section=notifications"
			class="flex items-center justify-between p-4 border-b border-gray-100 hover:bg-gray-50 transition-colors">
			<div class="flex items-center space-x-3">
				<div class="text-blue-500">
					<i data-lucide="bell" class="w-5 h-5"></i>
				</div>
				<span class="text-sm font-medium text-gray-800">Cài Đặt Thông
					Báo</span>
			</div> <i data-lucide="chevron-right" class="w-5 h-5 text-gray-300"></i>
		</a> <a href="profile?section=languages"
			class="flex items-center justify-between p-4 border-b border-gray-100 hover:bg-gray-50 transition-colors">
			<div class="flex items-center space-x-3">
				<div class="text-purple-500">
					<i data-lucide="languages" class="w-5 h-5"></i>
				</div>
				<span class="text-sm font-medium text-gray-800">Cài Đặt Ngôn
					Ngữ</span>
			</div> <i data-lucide="chevron-right" class="w-5 h-5 text-gray-300"></i>
		...
		<form action="customerController" method="GET" id="logoutForm"
			...
			<i data-lucide="chevron-right"
				class="w-5 h-5 text-gray-300 pointer-events-none"></i>
		</form>
