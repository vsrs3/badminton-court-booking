			...
			<div
              ...
              <path
					...
					<div class="d-flex flex-column overflow-hidden">
						...
						<span class="header-subtitle d-none d-sm-block"> Nền tảng
							đặt sân cầu lông chuyên nghiệp số 1 Việt Nam </span>
					</div>
				</div>
				...
				<div class="d-flex gap-3 flex-shrink-0">
					...
					<a href="${pageContext.request.contextPath}/my-bookings"
						...
						<div class="customer-avatar">
							...
							%>
						</div> <span class="customer-name"><%=currentUser.getFullName()%></span>
					</a>
					<%
					} else {
					%>
					...
					<a href="${pageContext.request.contextPath}/auth/login"
						style="text-decoration: none" class="btn-auth btn-login"> ĐĂNG
						NHẬP </a> <a
						href="${pageContext.request.contextPath}/jsp/auth/register.jsp"
						style="text-decoration: none" class="btn-auth btn-register">
						ĐĂNG KÝ </a>
					<%
					}
					%>
		...
		<div class="search-container">
			...
			<div class="actions-section">
				<button class="action-btn" id="mapBtn">
					<i class="bi bi-map"></i> <span class="action-text">Bản đồ
						sân</span>
				</button>


				<a href="${pageContext.request.contextPath}/my-bookings"
					class="action-btn" id="historyBtn"> <i
					class="bi bi-calendar-check"></i> <span class="action-text">Lịch
						sử đặt</span>
				</a>

				<button id="favoriteBtn" class="action-btn">
					<i class="bi bi-heart"></i> <span class="action-text">Yêu
						thích</span>
				</button>
			</div>
