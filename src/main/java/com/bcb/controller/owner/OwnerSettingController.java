...
public class OwnerSettingController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (pathInfo == null || "/".equals(pathInfo)) {
			request.getRequestDispatcher("/jsp/owner/setting/setting-form.jsp").forward(request, response);
			return;
		}
		  ...
		  String action = pathInfo.replaceFirst("^/", ""); // "profile" | "change-password"
	        ...
	        switch (action) {
	            case "profile":
	                request.getRequestDispatcher("/jsp/owner/setting/owner-profile.jsp")
	                       .forward(request, response);
	                break;
	            case "change-password":
	                request.getRequestDispatcher("/jsp/owner/setting/owner-password.jsp")
	                       .forward(request, response);
	                break;
	            default:
	...
	private void updateProfile(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            response.sendRedirect(request.getContextPath() + "/owner/setting/profile");
    ...
    private void updatePassword(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            response.sendRedirect(request.getContextPath() + "/owner/setting/change-password");
