...
/**
 * REST API: POST /api/staff/recurring-booking/preview
 */
@WebServlet(name = "StaffRecurringBookingPreviewApiServlet", urlPatterns = {"/api/staff/recurring-booking/preview"})
public class StaffRecurringBookingPreviewApiServlet extends BaseStaffApiServlet {

    private final StaffRecurringBookingService service = new StaffRecurringBookingServiceImpl();

    /**
     * Previews recurring booking sessions with conflict handling and totals.
     */
    @Override
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            StaffRecurringBookingOutcomeDTO outcome = service.preview(body, auth.facilityId, staffId);
